...
/model — 显示当前模型信息`,
  ...
  "landing.archSubtitle": "Rust TUI + Web 双端独立实现，assistant-ui 驱动现代 Web 体验",
  "landing.archRustCore": "Rust 核心",
  "landing.archBrowser": "浏览器",
  "landing.archWebStack": "Web 独立实现",
  ...
  "landing.archMod1": "assistant-ui 运行时",
  "landing.archMod2": "Vercel AI SDK",
  "landing.archMod3": "客户端工具执行",
  "landing.archMod4": "BM25 + FTS5 记忆",
  "landing.archMod4Sub": "SQLite WASM",
  "landing.archMod5": "IndexedDB + 云同步",
  ...
  "landing.archPrivacy": "工具在浏览器本地执行 — Edge 仅代理 LLM 流",
