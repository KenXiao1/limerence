...
/model — Show current model info`,
  ...
  "landing.archSubtitle": "Rust TUI + Web — two independent implementations, assistant-ui powered web experience",
  "landing.archRustCore": "Rust Core",
  "landing.archBrowser": "Browser",
  "landing.archWebStack": "Independent Web Implementation",
  ...
  "landing.archMod1": "assistant-ui Runtime",
  "landing.archMod2": "Vercel AI SDK",
  "landing.archMod3": "Client-side Tools",
  "landing.archMod4": "BM25 + FTS5 Memory",
  "landing.archMod4Sub": "SQLite WASM",
  "landing.archMod5": "IndexedDB + Cloud Sync",
  "landing.archMod5Sub": "Supabase Realtime",
  "landing.archChat": "Vercel AI SDK streamText + frontendTools",
  "landing.archSearch": "Search proxy, bypasses browser CORS",
  "landing.archPrivacy": "Tools execute locally in browser — Edge only proxies LLM stream",
